...
public class HistorialClinicoController {
    ...
    public String registrarHistorial(@PathVariable("idCita") Integer idCita, Model model, RedirectAttributes attrs) {
        try {
            ...
            historial.setPaciente(cita.getPaciente()); // ✅ Esto es lo que faltaba
            historial.setMedico(cita.getMedico());     // ✅ También esto
    ...
    public String guardarHistorial(@ModelAttribute HistorialClinico historial, RedirectAttributes attrs) {
        try {
            System.out.println("ID PACIENTE: " + (historial.getPaciente() != null ? historial.getPaciente().getId() : "null"));
            System.out.println("ID MEDICO: " + (historial.getMedico() != null ? historial.getMedico().getId() : "null"));
            System.out.println("ID CITA: " + (historial.getCita() != null ? historial.getCita().getId() : "null"));
